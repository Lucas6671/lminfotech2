...
const cases = [
  ...
  },
  {
    ...
    description: "Estratégia de conteúdo com IA. Engajamento no Instagram dobrou em 45 dias.",
  ...
  },
  {
    ...
    description: "Site com agendamento, chatbot de atendimento e galeria de fotos dos pets atendidos.",
  ...
  },
  {
    ...
    name: "Studio Élise",
    description: "Landing page com galeria antes/depois e automação de confirmação por WhatsApp.",
  ...
  },
  {
    ...
    description: "GPT personalizado como tutor, automação de matrícula e site com área de alunos.",
